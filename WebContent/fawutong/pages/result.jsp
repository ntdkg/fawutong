...
<title>提示</title>
<link rel="stylesheet" href="${pageContext.request.contextPath}/fawutongadmin/css/bootstrap.min.css">
<script src="${pageContext.request.contextPath}/fawutongadmin/js/jquery-1.11.1.min.js"></script>
<script src="${pageContext.request.contextPath}/fawutongadmin/js/bootstrap.min.js"></script>
</head>
<body>
<!--操作结果对话框-->
