...
//				html += '	<div class="text" style="font-size:2rem;padding-bottom:10px;border-bottom: 1px solid #DFDFDF;"></div>';
				html += '</div>';
				$(self).append(html);
				...
				$.each(para.agoComment, function(k, v){
					...
					item += '		</div>';
					item += '		<div class="textInfo"> '+v.content+' </div>';
			...
			this.addNewComment = function(param){
				...
				item += '		</div>';
				item += '		<div class="textInfo"> '+param.content+' </div>';
				item += '		<div class="actions">';
