		...
		<div class="row">
				...
				<div class="panel-body">
					<div class="bootstrap-table">
						<div class="fixed-table-toolbar">
							...
							<div class="pull-right search"><input id="searchValue" class="form-control" type="text" placeholder="输入法院"></div>
						</div>
								...
								<table data-toggle="table" data-url="tables/data1.json" data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="name" data-sort-order="desc" class="table table-hover" style="margin-top: 0px;">
									<thead style="display: table-header-group;">
										<tr>
											...
											<th style="">
												<div class="th-inner sortable">案件编号</div>
												<div class="fht-cell"></div>
											</th>
											<th style="">
											...
											<th style="">
												<div class="th-inner sortable">立案日期</div>
												<div class="fht-cell"></div>
											</th>
											<th style="">
												<div class="th-inner sortable">审理日期</div>
												<div class="fht-cell"></div>
											</th>
											<th style="">
												<div class="th-inner sortable">审判长</div>
												<div class="fht-cell"></div>
											</th>
											<th style="">
									...
									<c:forEach items="${cases }" var="c">
										<tr data-index="0">
											...
											<td style="">${c.cid }</td>
											<td style="">${c.ctitle }</td>
											<td style="">${c.uid }</td>
											<td style="">${c.ctype }</td>
											<td style="">${c.cdate }</td>
											<td style="">${c.ctrialdate }</td>
											<td style="">${c.cpresidingjudge }</td>
											<td style="">${c.cgeneral }</td>
											<td style="">
												<a id="modal-85878" href="caseChange.html?id=${c.cid }" role="button"  data-toggle="modal">
				                    				修改
				                    			</a>
											</td>
											<td style="">
												<a id="modal-85878" href="#modal-container-85878_${c.cid }" role="button"  data-toggle="modal">删除</a>
				                    			<div class="modal fade" id="modal-container-85878_${c.cid }" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
				                    				<div class="modal-dialog">
				                    					<div class="modal-content">
				                    						...
				                    						<div class="modal-footer">
				                    							...
				                    							<button onclick="deleteCase(${c.cid })" type="button" class="btn btn-primary">
				                    								确认
				                    							</button>
				                    						</div>
				                    					</div>
		 ...
		 <script type="text/javascript">
            ...
            function deleteCase(id) {
            	location.href="caseDel.html?id="+id;
            }
            
            $("button#search").click(function(){
            	var val = $("#searchValue").val();
            	location.href="case.html?search="+val;
            })
